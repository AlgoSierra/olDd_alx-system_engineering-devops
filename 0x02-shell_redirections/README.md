...
5. I'd prefer the first ones actully - Display the first 10 lines of /etc/passwd
...
16. What's next? - isplay lines containing the pattern “root” and 3 lines after them in the file /etc/passwd.
